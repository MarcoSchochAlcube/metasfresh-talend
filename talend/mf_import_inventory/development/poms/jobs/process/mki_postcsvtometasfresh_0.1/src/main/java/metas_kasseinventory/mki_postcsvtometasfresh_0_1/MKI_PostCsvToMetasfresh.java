...
package metas_kasseinventory.mki_postcsvtometasfresh_0_1;
...
/**
 * Job: MKI_PostCsvToMetasfresh Purpose: Post den Inhalt der Datei nach metasfresh<br>
 * Description: Es wird ein spezieller Endpunkt verwendet.
api/import/text, da wegen boundaries der api/import nicht funzt! <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MKI_PostCsvToMetasfresh implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(csvFileName != null){
					...
					this.setProperty("csvFileName", csvFileName.toString());
...
public String getMetasfreshApiKey(){
	...
	private final String jobName = "MKI_PostCsvToMetasfresh";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MKI_PostCsvToMetasfresh.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MKI_PostCsvToMetasfresh.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh = new byte[0];
    static byte[] commonByteArray_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh.length) {
				if(length < 1024 && commonByteArray_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh.length == 0) {
   					commonByteArray_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh = new byte[1024];
				} else {
   					commonByteArray_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh, 0, length);
			strReturn = new String(commonByteArray_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_METAS_KASSEINVENTORY_MKI_PostCsvToMetasfresh) {
 ...
 */
	...
	currentComponent="tFileInputRaw_1";
        ...
        new BytesLimit65535_tFileInputRaw_1().limitLog4jByte();
				...
				try {					
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(new java.io.File(context.csvFileName), "ISO-8859-15");
					row1.content = content_tFileInputRaw_1;					
					globalMap.put("tFileInputRaw_1_FILENAME_PATH", context.csvFileName);
...
// # Output table : 'row3'
row3_tmp.body = null;
row3_tmp.string = (String)row2.content ;
row3 = row3_tmp;
// ###############################
...
try {
	...
	String requestString_tRESTClient_1 = null;
			if (null != row3.body) {
				requestDoc_tRESTClient_1 = row3.body.getDocument();
			}
			requestString_tRESTClient_1 = row3.string;
	...
	final java.util.List<org.apache.cxf.feature.Feature> features_tRESTClient_1 =
		...
		String url = context.metasfreshApiBaseUrl;
		// {baseUri}tRESTClient
	...
	// set request path
	webClient_tRESTClient_1.path("api/import/text");
	...
	final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil.decryptPassword("f4f7aba1746784ea");
		...
		webClient_tRESTClient_1.header("Authorization", context.metasfreshApiKey);
	...
	// if FORM request then capture query parameters into Form, otherwise set them as queries
			...
			webClient_tRESTClient_1.query("completeDocuments" ,"true");
		
			webClient_tRESTClient_1.query("dataImportConfig" ,"Inventory");
	...
	try {
		...
		if (webClientResponseStatus_tRESTClient_1 >= 300) {
			...
			row5.errorCode = ex_tRESTClient_1.getResponse().getStatus();
			...
			row5.errorMessage = errorMessage_tRESTClient_1;
...
String message = context.csvFileName + "|" + row6.string;
LOG4J_Tools.writeToLog4j("MKI", "INFO", "PostCsvDataToMetasfresh", String.valueOf(row6.statusCode), message);
    nb_line_tJavaRow_1++;   
...
String message = context.csvFileName + "|" + row7.errorMessage;
LOG4J_Tools.writeToLog4j("MKI", "ERROR", "PostCsvDataToMetasfresh", String.valueOf(row7.errorCode), message);
 ...
 */
    ...
    public static void main(String[] args){
        final MKI_PostCsvToMetasfresh MKI_PostCsvToMetasfreshClass = new MKI_PostCsvToMetasfresh();

        int exitCode = MKI_PostCsvToMetasfreshClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MKI_PostCsvToMetasfresh.class.getClassLoader().getResourceAsStream("metas_kasseinventory/mki_postcsvtometasfresh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MKI_PostCsvToMetasfresh.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            if(!context_param.isEmpty()) {
				...
				for (Object key: context_param.keySet()){
				    ...
				    context.setContextType("csvFileName", "id_String");
				
                context.csvFileName=(String) context.getProperty("csvFileName");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("csvFileName")) {
                context.csvFileName = (String) parentContextMap.get("csvFileName");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MKI_PostCsvToMetasfresh");
        }
...
/************************************************************************************************
 *     82345 characters generated by Talend Open Studio for ESB 
